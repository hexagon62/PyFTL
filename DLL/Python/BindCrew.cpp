...
void bindCrew(py::module_& module)
{
	...
	py::class_<Crew>(module, "Crew", "A crewmember")
		...
		.def_readonly("dying", &Crew::dying, "If the crewmember is playing their dying animation")
		...
		.def_readonly("selection_id", &Crew::selectionId, "The crew's placement in the selected crew list. -1 if not selected")
