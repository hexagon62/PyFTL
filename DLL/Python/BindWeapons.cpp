...
void bindWeapons(py::module_& module)
{
	...
	py::class_<Weapon>(module, "Weapon", "A weapon")
		...
		.def_readonly("power", &Weapon::power, "The power state of the weapon")
		.def_readonly("player", &Weapon::player, "If the weapon belongs to the player")
		...
		.def_readonly("cargo", &Weapon::cargo, "If the weapon is in the ship's cargo")
		...
		.def("powered", &Weapon::powered, "Check if the weapon is powered")
		;
	...
	py::class_<Projectile>(module, "Projectile", "A projectile")
		...
		.def_readonly("dying", &Projectile::dying, "If the projectile is playing its dying animation")
